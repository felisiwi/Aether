...
export interface GameCardTagProps {
  children: string;
  type?: TagType;
  state?: TagState;
  className?: string;
...
/** Game card row tag (type/state). For DS pill tags see `Tag.1.0.0`. */
export const Tag: React.FC<GameCardTagProps> = ({
  children,
  type = "default",
  state = "active",
  className,
