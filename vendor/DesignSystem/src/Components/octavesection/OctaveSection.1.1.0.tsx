...
export interface OctaveSectionProps {
  /** Octave number for white-key labels (e.g. 4 → C4 … B4). */
  octave: number;
  pressedNotes?: string[];
  /** Maps to {@link PianoKey} `variant` (`default` = piano, `instrument` = keyboard cap). */
...
/**
 * One octave of {@link PianoKey} instances (7 white + 5 black) as a horizontal tile.
 */
