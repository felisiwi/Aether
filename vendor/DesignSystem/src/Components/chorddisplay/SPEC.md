...
- Chord name (middle): `typography.titleL`; color = `colors.textHeadingColour` (local) or `themeTokens.components.primary50` (remote).
...
| Remote | Purple card with purple heading text | `themeTokens.components.primary50`, `themeTokens.components.primary10` |
